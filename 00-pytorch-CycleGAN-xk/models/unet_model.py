...
class UnetModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        # summary(self.netG, input_size=(1,512,512))
        #
        # netG = self.netG
    ...
    def backward_G(self):
        ...
        self.loss_G = self.loss_G_L1 + self.loss_G_L1a
        # self.loss_G = self.loss_G_GAN * 0 + self.loss_G_L1
        # print('0.01')
